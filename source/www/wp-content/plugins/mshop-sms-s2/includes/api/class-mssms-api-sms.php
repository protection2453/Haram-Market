...
if ( ! class_exists( 'MSSMS_API_SMS' ) ) {
	...
	class MSSMS_API_SMS {
		...
		public static function send_message( $type, $send_no, $title, $message, $recipients, $request_date ) {
			$result = self::call( array (
				'command'      => 'send_message',
				'type'         => $type,
				'send_no'      => $send_no,
				'title'        => empty( $title ) ? sprintf( '[%s]', get_option( "blogname" ) ) : $title,
				'message'      => $message,
