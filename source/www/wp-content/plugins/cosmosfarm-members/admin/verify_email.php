			...
			<tbody>
				<tr valign="top">
					...
					<td>
						...
						<p class="description">※ 호스팅 서버와 메일 서비스에 따라서 메일 전송이 원활하지 못할 수 있습니다. <a href="https://wordpress.org/plugins/wp-mail-smtp/" onclick="window.open(this.href);return false;">WP Mail SMTP</a> 플러그인을 사용해서 보내는 메일을 세팅하시면 도움될 수 있습니다.</p>
					</td>
				</tr>
				<tr valign="top">
